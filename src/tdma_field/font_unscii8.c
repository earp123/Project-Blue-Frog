...
static const uint8_t font_unscii8_data[95][8] = {
	/* 32 ' ' */
...
FONT_ENTRY_DEFINE(font_unscii8, 8, 8, CFB_FONT_MONO_VPACKED, font_unscii8_data, 32, 126);

#endif /* CONFIG_APP_TDMA_FIELD */
